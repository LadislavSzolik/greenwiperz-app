<nav x-data="{ open: false }" class="fixed top-0 right-0 w-full bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="" :active="request()->routeIs('bookings.create')">
                        {{ __('Service area') }}
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-responsive-nav-link href="{{ route('how.it.works') }}" :active="request()->routeIs('how.it.works')">
                    {{ __('How it works') }}
                </x-jet-responsive-nav-link>
                ...
                <x-jet-responsive-nav-link href="{{ route('bookings.create') }}" :active="request()->routeIs('bookings.create')">
                    {{ __('About us') }}
                </x-jet-responsive-nav-link>
