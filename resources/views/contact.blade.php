    ...
    <main class="relative pt-16">   
        ...
        <div class="bg-white py-10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <h1 class="text-4xl tracking-tight leading-10 font-extrabold text-gray-800 sm:text-5xl sm:leading-none">{{ __('homepage.contactInformation') }}</h1>
                ...
                <div class="sm:flex">
                    ...
                    <img class="h-80 sm:h-64 mx-auto sm:mx-px" src="{{ asset('img/contact_us.png') }}" alt="Contact us" />
                </div>
            </div>
        </div>
