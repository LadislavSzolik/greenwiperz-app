    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('ratings.store') }}">
            ...
            <div class="my-4 text-center text-gray-600">
                <h1 class="text-2xl uppercase font-bold mb-4 ">{{__('Rate our services')}}</h1>
                <p class="text-left">
                   {{_(' We are constantly making our services better, your experience and opinion matter to us!')}}
                </p>
            </div>
            <div>
                <input hidden name="user" value="{{$user}}" />
                <x-jet-label for="level" value="{{__('How happy are you with us?')}}" />
                ...
                <div class="mt-4">
                    ...
                    <textarea name="comment" class="mt-1 block w-full form-input" rows="4" cols="50" required></textarea>
                </div>
            </div>
