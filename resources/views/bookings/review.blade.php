<x-app-layout>
    ...
    @empty($newBooking)
        <x-content-section>
         <div class="text-sm text-red-500"> 
             Due to the page refresh the data has been lost... Please go to "New booking" to restart the process. 
         </div>
        </x-content-section>
    @endempty
    ...
    <form method="POST" action="https://pay.sandbox.datatrans.com/upp/jsp/upStart.jsp">
        @csrf
        <div class="max-w-6xl mx-auto py-5 sm:px-6 lg:px-8 mt-2 md:mt-0">
