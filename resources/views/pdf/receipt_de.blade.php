...
<body>
    <table class="w-100" cellpadding="0" cellspacing="0">
        ...
        <tr >
            <td class="first-table font-weight-bold align-top"  colspan="2"> Quittungsempfänger</td>
            <td ></td>
            <td ></td>
            <td class="first-table font-weight-bold">Quittungs-Nr. </td>
            <td class="text-right align-top first-table font-weight-bold">{{ $booking->receipt->receipt_nr }}</td>
        </tr>
        <tr >
            ...
            <td class="text-right align-top"> 
                <p>{{ $booking->receipt->displayCreationDate }}</p>               
            </td>
        </tr>
    </table>
