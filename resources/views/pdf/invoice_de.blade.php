...
<body>
    <table class="w-100" cellpadding="0" cellspacing="0">
        ...
        <tr >
            <td class="first-table font-weight-bold align-top"  colspan="2"> Rechnungsempfänger</td>
            <td ></td>
            <td ></td>
            <td class="first-table font-weight-bold">Rechnungs-Nr. </td>
            <td class="text-right align-top first-table font-weight-bold">{{ $booking->invoice->invoice_nr }}</td>
        </tr>
        <tr >
            ...
            <td class="text-right align-top"> 
                <p>{{ $booking->invoice->displayCreationDate }}</p>               
            </td>
        </tr>
    </table>
    <table class="w-100 second-table">
        ...
        <tr>
            ...
            <td class="text-right">{{ $booking->bookingTimeslot->date }} {{ $booking->bookingTimeslot->start_time }}</td>
        </tr>
    </table>
    ...
    <table class="w-100 third-table">
        ...
        <tr>
            <td class="font-weight-bold bold-bottom">Total</td>
