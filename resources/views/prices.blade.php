<x-guest-layout>
    ...
    <div class="max-w-7xl mx-auto pt-20">
        <div class="bg-white rounded-lg shadow-sm px-4 py-10 sm:px-16 sm:py-12">
            ...
            <h2 class="text-xl leading-9 font-bold text-gray-900 sm:text-2xl sm:leading-10 mb-4 uppercase text-center">
                {{ __('pricespage.title') }}
            </h2>
                            ...
                            <table class="min-w-full divide-y divide-green-400">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <x-prices.row size='M' exteriorPrice='CHF 70.00' exteriorDuration='45 min*'
                                        ...
                                        <x-slot name="carExamples">
                                            {{ __('pricespage.carcategory2examples') }} <br/>{{ __('pricespage.carcategory2desc') }}
                                            </p>
                                        </x-slot>
                                    </x-prices.row>
