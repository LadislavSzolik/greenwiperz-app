...
class PaymentController extends Controller
{
    ...
    public function redirectToDatatrans(Request $request) {
        ...
        $payload = [
            ...
            'autoSettle' => true,
            'redirect' =>
                ['successUrl' => route('handlePaymentSucceeded'), //url('/').'/payments/handlePaymentSucceeded',
                'cancelUrl' => route('handlePaymentCanceled'), //url('/').'/payments/handlePaymentCanceled',
                'errorUrl' => route('handlePaymentFailed'), //url('/').'/payments/handlePaymentFailed',
                'method' => 'POST',
                ]
        ];
